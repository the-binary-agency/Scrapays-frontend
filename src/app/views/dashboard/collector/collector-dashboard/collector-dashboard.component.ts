...
export class CollectorDashboardComponent implements OnInit {
  ...
  constructor ( private formBuilder: FormBuilder, private modal: NgbModal, private api: ApiService, private Token: TokenService, private Auth: AuthService, private zone: NgZone, private ref: ChangeDetectorRef ) {  
    this.getUser();
  }
