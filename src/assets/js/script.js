...
jQuery(function ($) {
  ...
  var images = [
    'home-scrap-carousel-6.png',
    'home-scrap-carousel-3.png',
    'home-scrap-carousel-7.png',
    'home-scrap-carousel-1.png',
    'home-scrap-carousel-2.png',
    'home-scrap-carousel-4.png',
    'home-scrap-carousel-5.png',
  ];
  $(function () {
    var i = 0;
    $('#dvImage').css(
      'background-image',
      'url(assets/images/carousels/' + images[i] + ')'
    );
  ...
  $(window).click(function (event) {
    if (
      '#' + event.target.id == $('#loginModal').selector ||
      '#' + event.target.id == $('#signupModal').selector ||
      '#' + event.target.id == $('#notificationsModal').selector
    ) {
      $('#loginModal').hide();
      $('#signupModal').hide();
      $('#notificationsModal').hide();
